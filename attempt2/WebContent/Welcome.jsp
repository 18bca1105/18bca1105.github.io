    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                ...
                <div class="main-button scroll-to-section position">
                   
                   
                   
                 <a href="send.jsp">    <button type="button" class="btn btn-info btn-lg">Send money</button></a>
                    
                    </div>
                   
                
                
                <div class="main-button scroll-to-section position2">
                    
                    
                   
                   <a href="add.jsp"> <button type="button" class="btn btn-info btn-lg">Add money</button></a>
