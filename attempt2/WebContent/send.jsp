...
%>
    ...
    <!-- ***** Header Area End ***** -->
         ...
         <form action="money_send"  method="post"> 
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            ...
            <div class="acc"><h5 > Account No=  ${ account_no } </h5></div>
               ...
               <div class="col-xs-3">
                <div class="fit2"><h6 id="rs">Account no:</h6></div>
                       <input  type="text" class="form-control"  name="account_ad" required/><br>
                       <input  type="text" class="form-control"  name="money_ad" required/>
                       <div class="fit3"><h6 id="rs">Amount:</h6></div>
                    </div>
                ...
                <div class="main-button scroll-to-section position7">
                    
                     <button type="submit" class=" btn-info btn-lg">Send money</button>
